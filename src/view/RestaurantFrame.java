...
public class RestaurantFrame extends JFrame {
	...
	private static JTable myTable;
			...
			private static void displayTable() {
				try{  
					...
					DefaultTableModel model = new DefaultTableModel(new String[]{"RestaurantName", "CuisineType", "HasHappyHour"}, 0);

					String sql="SELECT ResturantName, CuisineType, HasHappyHour FROM hotelrestaurant";
					ResultSet rs = stmt.executeQuery(sql);
					while(rs.next()) {
						String a = rs.getString("ResturantName");
						String b = rs.getString("CuisineType");
						String c = rs.getString("HasHappyHour");
	...
	public RestaurantFrame() {
		...
		setIconImage(Toolkit.getDefaultToolkit().getImage(RestaurantFrame.class.getResource("/resources/w.gif")));
		...
		JLabel lblOkThen = new JLabel("Husky Hotel Restaurants");
		...
		myTable.setModel(new DefaultTableModel(
			...
			new String[] {
				"Restaurant", "CuisineType", "Has Happy Hour"
			}
		));
		displayTable();
